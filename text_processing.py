...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  6 11:54:04 2022

This module cotians functions
that are useful fro text processing.

It also cotains tests. To run 
the test, run the script directly
